...
| Tỉ lệ chuyển thừa | *điền* | Chấp nhận cao, xem [ADR-0005](../docs/adr/0005-nguong-tu-choi-thay-vi-doan.md) |
...
2. Đọc lại [`data/LABEL_GUIDE.md`](../data/LABEL_GUIDE.md) — ranh giới đã được định nghĩa rõ chưa, hay chính định nghĩa nhãn mới là vấn đề?
...
Đo bằng [`scripts/bench_server.py`](../scripts/bench_server.py). **Bắt buộc đo trên cả hai cấu hình**, bất kể cấu hình nào là chuẩn của lớp.
